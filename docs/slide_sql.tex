...
\texttt{SavingGoalCategories}& Stores predefined and custom saving goal categories. \\
...
& One-to-many
& One user can generate multiple authentication audit log records over time. \\
...
& One-to-one
& Each transaction-goal link refers to exactly one goal contribution record. \\
